...
export default {
  ...
  setup() {
    ...
    const submitData = () => {
      ...
      store.dispatch("actDodajObuku", formData);
    };
    ...
    onMounted(async () => {
      ...
      formData.instruktorId = instrukorAuth.value;
    });
